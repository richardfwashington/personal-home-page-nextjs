...
export default function Home() {
  return (
    <div className="info">
      ...
      <p className="italic confession">
        * I can&apos;t any take credit for this at all, the great guys at{" "}
        <a href="https://www.midjourney.com/home/">Midjouney</a> did all the
        work here, plus all of the <strong>real</strong> artists who produced
        the source work the AI smudged together.
        <br />
      </p>
      <ul>
        <li className="mb-5">
          <Link href="/articles/php-is-good-now-actually">PHP Is Good</Link>
        </li>
        <li className="mb-5">
          <Link href="/articles/1">Dynamic article</Link>
        </li>
        <li className="mb-5">
          <Link href="/articles/2">Another dynamic article</Link>
        </li>
      </ul>
    </div>
  );
